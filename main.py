...
root = Tk()
root.title("ISRO SDSC SHAR Employee Management System")
...
email = StringVar()
contact = StringVar()
image = Image.open("C://Users//balaj//OneDrive//Desktop//download.png")  
image = image.resize((300, 300))
photo = ImageTk.PhotoImage(image)
entries_frame = Frame(root, bg="#535c68")
entries_frame.pack(side=TOP, fill=X)
title = Label(entries_frame, text="ISRO SDSC SHAR Employee Management System", font=("Calibri", 18, "bold"), bg="#535c68", fg="white")
...
image_label = Label(root, image=photo, bg="#2c3e50")
image_label.photo = photo
image_label.place(x=root.winfo_screenwidth() - 400, y=90)
def getData(event):
